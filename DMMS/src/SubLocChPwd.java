...
public class SubLocChPwd extends HttpServlet
{
 //String c,a;
     ...
     throws IOException,ServletException
{
	try
	{
  	...
  	res.setContentType("text/html");
   	...
   	pw.println("<font color=red> SubLocation Password Change</font></u></center>");
   	pw.println("<form METHOD=POST ACTION=./SubLocChPwd1>");
   	pw.println("<br><br>");
