...
public class SLPendingOrder extends HttpServlet
{
    public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
	{
		...
		out.println("<html><body bgcolor=lightyellow><center><font color=red><b><u>SubLOcation PendingOrder</b></u></font><br><br>");
		...
		ResultSet rs=st.executeQuery("select * from retailerpurchaseorder where sliid="+subinchargeid);
		...
		rs1.beforeFirst();
        	...
        	out.println("<tr><th>RPOID</th><th>SLIID</th><th>RetailerPAYEMENTDATE</th><th>CHEQUE/DDNO</th></tr>");	     
